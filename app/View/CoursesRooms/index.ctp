<div class="coursesRooms index">
	<h2><?php echo __('Courses Rooms'); ?></h2>
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $coursesRoom['CoursesRoom']['id']), null, __('Are you sure you want to delete # %s?', $coursesRoom['CoursesRoom']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
