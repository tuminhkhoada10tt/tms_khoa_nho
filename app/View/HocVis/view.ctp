<div class="hocVis view">
<h2><?php echo __('Hoc Vi'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($hocVi['HocVi']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($hocVi['HocVi']['name']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Hoc Vi'), array('action' => 'edit', $hocVi['HocVi']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Hoc Vi'), array('action' => 'delete', $hocVi['HocVi']['id']), null, __('Are you sure you want to delete # %s?', $hocVi['HocVi']['id'])); ?> </li>
...
<div class="related">
	...
	<?php foreach ($hocVi['User'] as $user): ?>
		<tr>
