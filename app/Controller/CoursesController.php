...
class CoursesController extends AppController {
    ...
    public $helpers = array('TinymceElfinder.TinymceElfinder', 'Time');
    ...
    public function student_khoa_moidangki() {
        $contain = array(
            'User' => array('fields' => array('id', 'name')), //create user
            'Teacher' => array('fields' => array('id', 'name')), //Teacher
        ...
        $this->set(compact('courses_register'));
        return $courses_register;
    }

    public function teacher_class_organize() {
        $contain = array(
            'User' => array('fields' => array('id', 'name')), //create user
            'Teacher' => array('fields' => array('id', 'name')), //Teacher
            'CoursesRoom' => array('Room' => array('id', 'name')),
        ...
        $conditions = array(array('Course.teacher_id' =>$teacher_id));
        $courses_organize = $this->Course->find('all', array('conditions' => $conditions, 'contain' => $contain));
        $this->set(compact('$courses_organize'));
        return $courses_organize;
    }
